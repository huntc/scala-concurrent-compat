...
public class CompletableFuture<T> implements Future<T>, DeferredResult<T> {
     ...
     */
    @Override
    public <U> DeferredResult<U> thenApplyAsync
        (Function<? super T,? extends U> fn) {
    ...
    private <U> DeferredResult<U> doThenApply
        (Function<? super T,? extends U> fn,
         Executor e) {
     ...
     */
    @Override
    public DeferredResult<Void> thenAccept(Consumer<? super T> block) {
     ...
     */
    @Override
    public DeferredResult<Void> thenAcceptAsync(Consumer<? super T> block) {
    ...
    private DeferredResult<Void> doThenAccept(Consumer<? super T> fn,
                                                 Executor e) {
        if (fn == null) throw new NullPointerException();
     ...
     */
    @Override
    public DeferredResult<Void> thenRunAsync(Runnable action) {
    ...
    private DeferredResult<Void> doThenRun(Runnable action,
                                              Executor e) {
     ...
     */
    @Override
    public <U,V> DeferredResult<V> thenCombine
     ...
     */
    @Override
    public <U,V> DeferredResult<V> thenCombineAsync
        (DeferredResult<? extends U> other,
         BiFunction<? super T,? super U,? extends V> fn) {
    ...
    private <U,V> DeferredResult<V> doThenCombine
        (DeferredResult<? extends U> other,
         BiFunction<? super T,? super U,? extends V> fn,
         Executor e) {
        ...
        Object r, s = null;
        if ((r = result) == null || (s = otherCf.result) == null) {
            d = new ThenCombine<T,U,V>(this, otherCf, fn, dst, e);
            CompletionNode q = null, p = new CompletionNode(d);
            while ((r == null && (r = result) == null) ||
                   (s == null && (s = otherCf.result) == null)) {
                if (q != null) {
                    if (s != null ||
                        UNSAFE.compareAndSwapObject
                        (otherCf, COMPLETIONS, q.next = otherCf.completions, q))
                        break;
                }
                else if (r != null ||
                         UNSAFE.compareAndSwapObject
     ...
     */
    @Override
    public <U> DeferredResult<Void> thenAcceptBoth
        (DeferredResult<? extends U> other,
     ...
     */
    @Override
    public <U> DeferredResult<Void> thenAcceptBothAsync
        (DeferredResult<? extends U> other,
         BiConsumer<? super T, ? super U> block) {
    ...
    private <U> DeferredResult<Void> doThenAcceptBoth
        (DeferredResult<? extends U> other,
         BiConsumer<? super T,? super U> fn,
         Executor e) {
        if (other == null || fn == null) throw new NullPointerException();
        ...
        Object r, s = null;
        if ((r = result) == null || (s = otherCf.result) == null) {
            d = new ThenAcceptBoth<T,U>(this, otherCf, fn, dst, e);
            CompletionNode q = null, p = new CompletionNode(d);
            while ((r == null && (r = result) == null) ||
                   (s == null && (s = otherCf.result) == null)) {
                if (q != null) {
     ...
     */
    @Override
    public DeferredResult<Void> runAfterBoth(DeferredResult<?> other,
                                             Runnable action) {
     ...
     */
    @Override
    public DeferredResult<Void> runAfterBothAsync(DeferredResult<?> other,
                                                  Runnable action) {
    ...
    private DeferredResult<Void> doRunAfterBoth(DeferredResult<?> other,
                                                Runnable action,
                                                Executor e) {
        ...
        Object r, s = null;
        if ((r = result) == null || (s = otherCf.result) == null) {
             d = new RunAfterBoth(this, otherCf, action, dst, e);
            CompletionNode q = null, p = new CompletionNode(d);
            while ((r == null && (r = result) == null) ||
                   (s == null && (s = otherCf.result) == null)) {
                if (q != null) {
     ...
     */
    @Override
    public <U> DeferredResult<U> applyToEither
     ...
     */
    @Override
    public <U> DeferredResult<U> applyToEitherAsync
        (DeferredResult<? extends T> other,
         Function<? super T, U> fn) {
    ...
    private <U> DeferredResult<U> doApplyToEither
        (DeferredResult<? extends T> other,
         Function<? super T, U> fn,
         Executor e) {
        if (other == null || fn == null) throw new NullPointerException();
        ...
        Object r;
        if ((r = result) == null && (r = otherCf.result) == null) {
             d = new ApplyToEither<T,U>(this, otherCf, fn, dst, e);
            CompletionNode q = null, p = new CompletionNode(d);
            while ((r = result) == null && (r = otherCf.result) == null) {
                if (q != null) {
                    if (UNSAFE.compareAndSwapObject
                        (otherCf, COMPLETIONS, q.next = otherCf.completions, q))
                        break;
     ...
     */
    @Override
    public DeferredResult<Void> acceptEither
        (DeferredResult<? extends T> other,
     ...
     */
    @Override
    public DeferredResult<Void> acceptEitherAsync
        (DeferredResult<? extends T> other,
         Consumer<? super T> block) {
    ...
    private DeferredResult<Void> doAcceptEither
        (DeferredResult<? extends T> other,
         Consumer<? super T> fn,
         Executor e) {
        if (other == null || fn == null) throw new NullPointerException();
        ...
        Object r;
        if ((r = result) == null && (r = otherCf.result) == null) {
            d = new AcceptEither<T>(this, otherCf, fn, dst, e);
            CompletionNode q = null, p = new CompletionNode(d);
            while ((r = result) == null && (r = otherCf.result) == null) {
                if (q != null) {
                    if (UNSAFE.compareAndSwapObject
     ...
     */
    @Override
    public DeferredResult<Void> runAfterEither(DeferredResult<?> other,
                                               Runnable action) {
     ...
     */
    @Override
    public DeferredResult<Void> runAfterEitherAsync
    ...
    private DeferredResult<Void> doRunAfterEither
        (DeferredResult<?> other,
         Runnable action,
         Executor e) {
        if (other == null || action == null) throw new NullPointerException();
        ...
        Object r;
        if ((r = result) == null && (r = otherCf.result) == null) {
            d = new RunAfterEither(this, otherCf, action, dst, e);
            CompletionNode q = null, p = new CompletionNode(d);
            while ((r = result) == null && (r = otherCf.result) == null) {
                if (q != null) {
                    if (UNSAFE.compareAndSwapObject
     ...
     */
    @Override
    public <U> DeferredResult<U> thenCompose
    ...
    private <U> DeferredResult<U> doThenCompose
        (Function<? super T, DeferredResult<U>> fn,
         Executor e) {
        if (fn == null) throw new NullPointerException();
        ...
        if ((r = result) == null) {
            ...
            CompletionNode p = new CompletionNode
                (d = new ThenCompose<T,U>(this, fnCf, dst, e));
            while ((r = result) == null) {
                if (UNSAFE.compareAndSwapObject
                    (this, COMPLETIONS, p.next = completions, p))
                    break;
        ...
        if (r != null && (d == null || d.compareAndSet(0, 1))) {
            ...
            if (ex == null) {
                if (e != null) {
                    if (dst == null)
                        dst = new CompletableFuture<U>();
                    e.execute(new AsyncCompose<T,U>(t, fnCf, dst));
                }
                else {
                    try {
                        if ((dst = fnCf.apply(t)) == null)
                            ex = new NullPointerException();
                    } catch (Throwable rex) {
                        ex = rex;
                    }
     ...
     */
    @Override
    public DeferredResult<T> exceptionally
     ...
     */
    @Override
    public <U> DeferredResult<U> handle
        (BiFunction<? super T, Throwable, ? extends U> fn) {
        if (fn == null) throw new NullPointerException();
        CompletableFuture<U> dst = new CompletableFuture<U>();
